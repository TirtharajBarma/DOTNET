...
ALTER TABLE ZIPCODE_INFO
ADD CONSTRAINT ZIP_CITY_NN
CHECK (CITY IS NOT NULL);

ALTER TABLE ZIPCODE_INFO
ADD CONSTRAINT ZIP_STATE_NN
...
ALTER TABLE INSTRUCTOR_INFO
ADD CONSTRAINT INSTRUCTOR_FN_NN
CHECK (INSTRUCTOR_FIRST_NAME IS NOT NULL);

ALTER TABLE INSTRUCTOR_INFO
ADD CONSTRAINT INSTRUCTOR_LN_NN
CHECK (INSTRUCTOR_LAST_NAME IS NOT NULL);
...
ALTER TABLE COURSE_INFO
ADD CONSTRAINT COURSE_NAME_NN
CHECK (COURSE_NAME IS NOT NULL);

ALTER TABLE COURSE_INFO
ADD CONSTRAINT COST_NN
...
ALTER TABLE STUDENT_INFO
ADD CONSTRAINT STUDENT_FN_NN
CHECK (STUDENT_FIRST_NAME IS NOT NULL);

ALTER TABLE STUDENT_INFO
ADD CONSTRAINT STUDENT_LN_NN
CHECK (STUDENT_LAST_NAME IS NOT NULL);
...
ALTER TABLE SECTION_INFO
ADD CONSTRAINT SECTION_NO_NN
CHECK (SECTION_NO IS NOT NULL);
